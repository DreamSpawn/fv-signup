<?php
     ...
     class aktiviteter_v1
     {
    	...
    	public function loadJSON($url){
    		...
    		curl_setopt($c, CURLOPT_URL, "http://127.0.0.1/".$url."?birthdate=".$birthdate."&brugertype=".$brugertype);
		...
		public function render()
		{
			...
			<div id='aktiviteter'>
    			<?php
        		 if ($this->attends_con_at_numday(1) && isset($afviklinger_daysplit[12])){
    	    	     $this->ft_aktiviteterByDayJSON(23, "Onsdag (12. april 2017)", $afviklinger_daysplit[12] );
        		 }
        		 if ($this->attends_con_at_numday(2) && isset($afviklinger_daysplit[13])){
        		     $this->ft_aktiviteterByDayJSON(24, "Torsdag (13. april 2017)", $afviklinger_daysplit[13] );
        		 }
        		 if ($this->attends_con_at_numday(3) && isset($afviklinger_daysplit[14])){
        		     $this->ft_aktiviteterByDayJSON(25, "Fredag (14. april 2017)", $afviklinger_daysplit[14] );
        		 }
        		 if ($this->attends_con_at_numday(4) && isset($afviklinger_daysplit[15])){
        		     $this->ft_aktiviteterByDayJSON(26, "Lørdag (15. april 2017)", $afviklinger_daysplit[15] );
        		 }
        		 if ($this->attends_con_at_numday(5) && isset($afviklinger_daysplit[16])){
        		     $this->ft_aktiviteterByDayJSON(27, "Søndag (16. april 2017)", $afviklinger_daysplit[16] );
        		 }
